...
public class MessagingController {
    ...
    public MessagingController(SimpMessagingTemplate template, NotificationService notificationService, RateLimiterService rateLimiterService) {
    ...
    @MessageMapping("/send")
    public void handleMessage(@Payload ClientMessage msg, Principal principal, SimpMessageHeaderAccessor accessor) {
...
// drop or send a rate-limited notice
    ...
    public static class BroadcastMessage { private String content; public String getContent(){return content;} public void setContent(String c){this.content=c;} }


    public static class RecoverRequest { private long lastSeenSeq; public long getLastSeenSeq(){return lastSeenSeq;} public void setLastSeenSeq(long s){this.lastSeenSeq=s;} }
}
