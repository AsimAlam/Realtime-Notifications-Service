...
/**
 * RateLimiterService: if Redis present uses simple increment-with-expire;
 * otherwise uses an in-memory per-second counter as a fallback.
 *
 * Note: in-memory fallback is NOT distributed and resets on app restart.
 */
@Service
